...
fun writeKmpBackgroundJobTypes(
    ...
    val interfaceName = ClassName("com.kprakash2.kmp.tools.models", "BackgroundJobType")
    FileSpec.builder(packageName, className)
        .indent("    ")
        .addFileComment("GENERATED BY com.kprakash2.kmp.workmanager plugin -- DO NOT MODIFY")
        .also {
            it.addImport(packageName = "com.kprakash2.kmp.tools.models.BackgroundJobType", "BackgroundJobType")
        }
        .addType(
